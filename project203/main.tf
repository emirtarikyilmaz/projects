...
provider "github" {
  # Configuration options
  token = "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"
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  user_data = <<-EOF
          ...
          TOKEN="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"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/emirtarikyilmaz/bookstore-repo/main/"
          ...
          docker build -t kenshi2100/bookstoreapi:latest .
          docker-compose up -d
          EOF
